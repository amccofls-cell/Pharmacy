...
# DUR 금기/주의 조회용 엔드포인트 (품목코드 itemSeq로 조회)
API_ENDPOINTS = {
...
# ------------------------------------------------------------------
# 세션 상태(Session State): 선택된 의약품 바구니 {"[코드] 이름": {"code": ..., "name": ...}}
# ------------------------------------------------------------------
...
if search_keyword.strip():
    ...
    if candidates:
        selected_labels = st.multiselect(
            "검색 결과 드롭다운에서 조회할 의약품을 선택하세요:",
            options=list(candidates.keys()),
            help="여러 개를 다중 선택할 수 있습니다.",
        )
